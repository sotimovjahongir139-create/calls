...
if __name__ == "__main__":
    ...
    scheduler.add_job(run_realtime_fetcher, "interval", minutes=10,  id="rt_fetcher")
    ...
    logger.info("Jobs: rt_fetcher(10min) calls_etl(06:00) telegram_etl(06:05) rating_persist(22:00)")
